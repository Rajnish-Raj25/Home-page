                ...
                <div className="row counter-content">
                  <div className="col-lg-3 col-3">
                    <div className=" cohorts">
                      <span id="counter-one-bottom">{stateone}</span>
                  ...
                  <div className="col-lg-3 col-3 counter-deployed">
                    <div className="success  cohorts">
                      <span id="counter-one-bottom">{statetwo}</span>
                  ...
                  <div className="col-lg-3 col-3 counter-avg-salary">
                    <div className=" cohorts">
                      <span id="counter-one-bottom">{state_three}</span>
                      <span className="cohorts-plus">+</span>
                      <p>Clients</p>
                    </div>
                  </div>
                  <div className="col-lg-3 col-3">
                    <div className="cohorts">
                      <span id="counter-one-bottom">{state_four}</span>
                      <span className="cohorts-plus">+</span>
                      <p>
                        Time <br />
                        Effiecency
