          ...
          <div className="offset-lg-1">
            <Fade top duration={2000}>
              ...
              <div className="row mt-3 how-it-all-started-4">
                ...
                <div className="col-lg-8 discription">
                  ...
                  <p className="content  content-4">
                    Get paid as per your current salary with a guaranteed hike
                    in 2 months
                  </p>
                </div>
              </div>
              ...
              <div className="row mt-3 how-it-all-started-7">
                ...
                <div className="col-lg-8 discription">
                  ...
                  <p className="content  content-7">
                    Get deployed in Fortune 500 companies, leading MNCs &
              ...
              <div className="row mt-3 how-it-all-started-8">
                ...
                <div className="col-lg-8 discription">
                  ...
                  <p className="content  content-8">
                    Get complete assistance even after deployment.{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="row mt-3 how-it-all-started-10">
                <div className="col-lg-2">
                  <img
                    className="how_it_started_img1 img10"
                    src={img10}
                    alt=""
                  />
                </div>
                ...
                <div className="col-lg-8 discription">
                  ...
                  <p className="content  content-10">
                    GGet converted as a full-time employee with the client or
                    get deployed with another client{" "}
                  </p>
                </div>
              </div>
            </Fade>
          ...
          <Fade top duration={1500}>
            ...
            <div className="row mt-4">
              ...
              <div className="col-6 ">
                <h4 className="headings">Payroll & Hikes</h4>
                <p className="content content-4">
                  Get paid as per your current salary with a guaranteed hike in
                  2 months
                </p>
              </div>
            </div>
            ...
            <div className="row mt-3">
              ...
              <div className="col-6 ">
                <h4 className="headings">Deployment</h4>
                <p className="content content-7">
                  Get deployed in Fortune 500 companies, leading MNCs, or
                  well-funded start-ups.
                </p>
              </div>
            </div>
            ...
            <div className="row mt-3">
              ...
              <div className="col-6 ">
                <h4 className="headings">Conversion</h4>
                <p className="content content-10">
                  Get converted as a full-time employee with the client or get
                  deployed with another client
                </p>
              </div>
            </div>
          </Fade>
